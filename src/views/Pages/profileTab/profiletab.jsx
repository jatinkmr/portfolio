    ...
    return (
        <div className='mainProfileDiv fade-in'>
            ...
            <div className='skills'>
                ...
                <div className='skillContentDetails'>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-html5" aria-hidden="true"></i> HTML</span>
                        <div className='skillGrade'>
                            <div className='htmlSkill'></div>
                        </div>
                    </div>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-react" aria-hidden="true"></i> JSX</span>
                        <div className='skillGrade'>
                            <div className='jsxSkill'></div>
                        </div>
                    </div>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-php" aria-hidden="true"></i> PHP</span>
                        <div className='skillGrade'>
                ...
                <div className='skillContentDetails'>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-css3-alt" aria-hidden="true"></i> CSS</span>
                        <div className='skillGrade'>
                            <div className='cssSkill'></div>
                        </div>
                    </div>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-bootstrap" aria-hidden="true"></i> Bootstrap</span>
                        <div className='skillGrade'>
                ...
                <div className='skillContentDetails'>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-react" aria-hidden="true"></i> ReactJS</span>
                        <div className='skillGrade'>
                            <div className='reactSkill'></div>
                        </div>
                    </div>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-node-js" aria-hidden="true"></i> NodeJS</span>
                        <div className='skillGrade'>
                    ...
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-vuejs" aria-hidden="true"></i> VueJS</span>
                        <div className='skillGrade'>
                ...
                <div className='skillContentDetails'>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-solid fa-database" aria-hidden="true"></i> MySQL</span>
                        <div className='skillGrade'>
                            <div className='phpMySqlSkill'></div>
                        </div>
                    </div>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-solid fa-leaf" aria-hidden="true"></i> MongoDB</span>
                        <div className='skillGrade'>
                ...
                <div className='skillContentDetails'>
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-git-alt" aria-hidden="true"></i> Git</span>
                        <div className='skillGrade'>
                    ...
                    <div className='skillSection'>
                        <span className='skillHeading'><i className="fa-brands fa-aws" aria-hidden="true"></i> AWS</span>
                        <div className='skillGrade'>
            ...
            <div className='experience'>
                ...
                <div className='skillHeader'>
                    <h3 className='a'><i className="fa-solid fa-graduation-cap" aria-hidden="true"></i> Internships</h3>
                </div>
